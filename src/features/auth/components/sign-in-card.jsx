...
export const SignInCard = () => {
    ...
    return (<Card className="size-full border-none shadow-none md:w-[487px]">
      ...
      <CardContent className="flex flex-col gap-y-3 p-7">
        ...
        <Button onClick={() => handleOAuth(OAuthProvider.Microsoft || 'microsoft')} disabled={isPending} variant="secondary" size="lg" className="w-full">
