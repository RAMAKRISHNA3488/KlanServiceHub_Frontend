...
export const UserButton = () => {
    ...
    if (isLoading) {
        return (<div className="flex size-10 items-center justify-center rounded-full border border-neutral-300 bg-neutral-200">
    ...
    return (<DropdownMenu modal={false}>
      ...
      <DropdownMenuContent align="end" side="bottom" className="w-60" sideOffset={10}>
        ...
        <DropdownMenuItem disabled={isPending} onClick={() => logout()} className="flex h-10 cursor-pointer items-center justify-center font-medium text-amber-700">
